...
LOGIN_REDIRECT_URL = '/create/'  # Куда перенаправлять после успешного входа
LOGOUT_REDIRECT_URL = '/create/'  # Куда перенаправлять после выхода
